    ...
    try:
        ...
        if choiceNumber == "1":
            ...
            if i > 5:
                ...
                while counter_1 <= i:
                    # These few lines will take information from the customer and then append them to the list.
            ...
            while j < 1:
                ...
                # This while loop will keep the function running when variable k is smaller than the
                # length of the customerNames list.
                while k < len(customerNames) - 1:
                    k = k + 1
                    # These two if conditions find where both the name and pin match.
                    if name == customerNames[k]:
                        if pin == customerPins[k]:
                            j = j + 1
                            # These few statements would show the balance taken from the list.
                            print("Your Current Balance:", end=" ")
                            print(customerBalances[k], end=" ")
                            print("-/Rs\n")
                            balance = (customerBalances[k])
                            # Statement below would take the amount to withdraw from the user.
                            withdrawal = eval(input("Input value to Withdraw : "))
                            # The if condition below would look whether the withdrawal is greater than the balance.
                            if withdrawal > balance:
                                ...
                                # These few statements would update the value and show the balance to the user.
                                balance = balance + deposition
                                print("Your Current Balance:", end=" ")
                                print(balance, end=" ")
                                print("-/Rs\n")
            ...
            print("\n")
            # The while loop below will keep running until all the customers and balances are shown.
            while k <= len(customerNames) - 1:
